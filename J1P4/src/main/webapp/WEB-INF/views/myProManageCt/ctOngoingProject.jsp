...
<!-- 폼태그 -->
<form role="form" action="/J1P4_PTP/myProManageCt/payment" method="post">
...
<form role="form" action="/J1P4_PTP/myProManageCt/requestSettlement" method="post">
	<input type="hidden" name="proj_no" value="${copDTO.proj_no }">
	<input type="hidden" name="free_no" value="${copDTO.free_no }">
	<input type="hidden" name="ct_no" value="${copDTO.ct_no }">	
</form>
							...
							<table class="table table-bordered bg-light table-striped">
								...
								<c:forEach var="copDTO" items="${ctOngoingProjectList}">
									<tr>
										...
										<td><a id="linkG" href="/J1P4_PTP/board/detailList?proj_no=${copDTO.proj_no }">${copDTO.proj_title }</a></td>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".btn-warning").click(function(){
			$("form[role='form']").attr("action","/J1P4_PTP/myProManageCt/payment");
		...
		$(".btn-dark").click(function(){
			$("form[role='form']").attr("action","/J1P4_PTP/myProManageCt/requestSettlement");
			$("form[role='form']").submit();			
