...
<div style="padding-top: 20px; margin-bottom: 70px;">
<div style="font-size: 20px; text-align: center; margin-top: 50px; font-weight: bold;">
가입할 때 입력한 이메일에서<br><i style="color:red;">인증메일 확인 링크를 클릭해주세요.</i>
</div>
