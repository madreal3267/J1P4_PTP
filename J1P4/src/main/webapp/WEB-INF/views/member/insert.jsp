...
<form class="form-horizontal" method="post" name="form_join" id="form1">
	...
	<div style="text-align: center; margin-bottom: 30px;">
		...
		<div style="margin-top: 30px; font-size: 20px;">
			함께 나눌수록 더욱 커지는 가치,<br> IT 전문가 세상 PTP에 오신것을 환영합니다.<br>
		</div>
	</div>
	...
	<div class="container light-style flex-grow-1 container-p-y"
		...
		<div class="card overflow-hidden card-2" style="padding: 10px;">
			<div
				style="font-size: 25px; padding-left: 26px; font-weight: bolder;">
				회원가입</div>
		</div>
	</div>
	...
	<div class="container light-style flex-grow-1 container-p-y"
		style="width: 500px; margin-bottom: 100px;">
		<div class="card overflow-hidden card-2">
			<div class="row no-gutters row-bordered row-border-light">


				<div
					style="padding-left: 50px; padding-top: 20px; margin-bottom: 20px;">
					<label for="inputEmail3" class="insertFont">이메일</label>
					<div class="col-sm-10">
						<input type="email" name="user_email" class="email inputInfo"
							id="inputEmail3" placeholder="이메일">
					</div>

					<label for="inputEmail3" class="insertFont">이름</label>
					<div class="col-sm-10">
						<input type="text" name="name" class="inputInfo" id="inputEmail3"
							placeholder="이름">
					</div>
					...
					<div class="col-sm-10">
						<input type="text" name="user_id" class="inputInfo" id="userid"
							placeholder="아이디"> <span id=check
							style="font-size: 14px;"></span>
					</div>

					<label for="inputPassword3" class="insertFont">비밀번호</label>
					<div class="col-sm-10">
						<input type="password" name="user_pw" class="pass inputInfo"
							id="pw1" placeholder="비밀번호"> <span id=checkpass2
							style="font-size: 14px;"></span>
					</div>

					<label for="inputPassword3" class="insertFont">비밀번호 확인</label>
					<div class="col-sm-10">
						<input type="password" name="user_pw2" class="pass inputInfo"
							id="pw2" placeholder="비밀번호 확인"> <span id=checkpass
							style="font-size: 14px;"></span>
					</div>
...
<div class="container">
	<footer class="py-3 my-4">
		...
		<p class="text-center text-body-secondary">© 2024-06-06
			Zip-Ga-Go-Ship-Da, Inc</p>
	</footer>
</div>
...
<script type="text/javascript">
	...
	$('#insertMember').click(function() {
		...
		location.href = '/J1P4_PTP/member/insert';
