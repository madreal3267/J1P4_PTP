...
<div style="position: relative;">
	...
	<c:if test="${empty sessionScope.user_id }">
	<div class="mainButt">
		<button class="rounded-3 p-3 butt1" type="button" onclick = "location.href = '/J1P4_PTP/member/insert'">회원가입</button>
		<button class="rounded-3 p-3 butt2" type="button" onclick = "location.href = '/J1P4_PTP/member/guide'">이용방법</button>
	</div>
	</c:if>
	...
	<c:if test="${not empty sessionScope.user_id && sessionScope.user_cf.equals('프리랜서') }">
	<div class="mainButt">
		<button class="rounded-3 p-3 butt1" type="button" onclick = "location.href = '/J1P4_PTP/board/listPro'">프로젝트 찾기</button>
		<button class="rounded-3 p-3 butt2" type="button" onclick = "location.href = '/J1P4_PTP/member/guide'">이용방법</button>
	</div>
	</c:if>
	...
	<c:if test="${not empty sessionScope.user_id && sessionScope.user_cf.equals('클라이언트') }">
	<div class="mainButt" >
		<button class="rounded-3 p-3 butt1" type="button" onclick = "location.href = '/J1P4_PTP/board/listFree'">프리랜서 찾기</button>
		<button class="rounded-3 p-3 butt2" type="button" onclick = "location.href = '/J1P4_PTP/member/guide'">이용방법</button>
	</div>
	</c:if>
