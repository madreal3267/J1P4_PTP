...
<link href="${pageContext.request.contextPath}/resources/css/ctHeader.css" rel="stylesheet" />
    ...
    <div class="container p-3" style="width: 1100px;">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0" >
          ...
          <li><a href="/J1P4_PTP/myProManageCt/interestFreelancer" class="nav-link px-2 link-body-emphasis nav-r4">내 프로젝트 관리</a></li>
        </ul>

        <div class="dropdown text-end pro-l" >
		  <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="${pageContext.request.contextPath}/resources/스마일감자.jpg" alt="profile" width="45" height="45" class="rounded-circle">
          </a>
