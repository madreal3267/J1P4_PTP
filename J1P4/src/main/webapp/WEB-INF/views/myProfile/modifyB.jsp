...
<body>
	<h1>내 프로필 수정하기 - 사업자(/myProfile/modifyB.jsp)</h1>
	<hr>
	...
	<h4 style="display: inline-block;"><span class="badge text-bg-warning m-3">${myComp.yearmonth }</span></h4>
	<h4 style="display: inline-block;"><span class="badge text-bg-warning m-3">${myComp.hDetails }</span></h4>
	<button class="removeButt btn-close" aria-label="Close" style="width: 1px; position: absolute; top: 21px; left: 360px;"></button></div></p>
	</c:forEach>
	...
	<h4 style="display: inline-block;"><span class="badge text-bg-warning m-3">${myPartn.partners_nm }</span></h4>
	<h4 style="display: inline-block;"><span class="badge text-bg-warning m-3">${myPartn.pDetails }</span></h4>
	<button class="removeButt btn-close" aria-label="Close" style="width: 1px; position: absolute; top: 21px; left: 360px;"></button></div></p>
	</c:forEach>
