...
<body>
	<h1>내 프로필 - 사업자 (/myProfile/profileB.jsp)</h1>
	<hr>
	...
	<c:forEach items="${myPartn }" var="myPartn">
		파트너사 및 협력기관 명 : ${myPartn.partners_nm }<br>
		협력 관계 설명 : ${myPartn.pDetails }<br>
	</c:forEach>

	<button type="button" onclick = "location.href = '/myProfile/modifyB?free_no=${sessionScope.free_no}'">수정하기</button>
