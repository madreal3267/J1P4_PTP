...
<body>
	...
	<h2>프로젝트를 간단하게 알려주세요</h2>
	  ...
	  <input type="radio" name="proj_progress" value=1 id="radioPj2">
	...
	<hr>
	<h2>모집 마감일</h2>
	<h5>프리랜서 모집을 마감할 날짜입니다.<br>
	해당 날짜에 프리랜서 모집이 자동으로 종료됩니다. </h5>
	...
	<h5>클라이언트님에게 편한 미팅 방식으로 프리랜서와의 미팅 조율을 도와드립니다.</h5>
	  ...
	  <input type="radio" name="pmeet_meth" value="오프라인" id="radioPme2">
	...
	<h5>미팅 방식</h5>
	  ...
	  <input type="radio" name="meet_meth" value="오프라인" id="radioMe2">
	  <label for="radioMe2">오프라인</label>
	<h5>미팅 주기</h5>
	  <input type="radio" name="meet_cycle" value="주 1회" id="radioCy1">
	  <label for="radioCy1">주 1회</label> <br>
	  <input type="radio" name="meet_cycle" value="주 2회" id="radioCy2">
	  <label for="radioCy2">주 2회</label> <br>
	  <input type="radio" name="meet_cycle" value="필요시 요청" id="radioCy3">
...
<!-- 	값을 선택했을 때 뷰페이지에 출력되는 기능 찾아보기 - 공통 코드 엮기 -->
	...
	<div class="btn-group" role="group" aria-label="Basic checkbox toggle button group"> 
	  ...
	  <label class="btn btn-outline-dark" for="radioLev1">주니어</label>
	
	  <input type="radio" value="미들" class="btn-check" name="job_level" id="radioLev2">
	  <label class="btn btn-outline-dark" for="radioLev2">미들</label>
	  
	  <input type="radio" value="시니어" class="btn-check" name="job_level" id="radioLev3">
	  <label class="btn btn-outline-dark" for="radioLev3">시니어</label>
	</div>
	...
	<h2>경력 증빙 자료</h2>
	<div class="btn-group" role="group" aria-label="Basic checkbox toggle button group"> 
	  <input type="radio" value=1 class="btn-check" name="career_proof" id="radioCp1">
	  <label class="btn btn-outline-dark" for="radioCp1">필수</label>
	
	  <input type="radio" value=0 class="btn-check" name="career_proof" id="radioCp2">
	  <label class="btn btn-outline-dark" for="radioCp2">무관</label>
	</div>
	...
	<hr>
	  <input type="button" value="임시저장" id="saveButt">
